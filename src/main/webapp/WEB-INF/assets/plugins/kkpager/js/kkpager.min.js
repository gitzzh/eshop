...
*/
var kkpager={
	pagerid:"kkpager",mode:"link",pno:1,total:1,totalRecords:0,isShowFirstPageBtn:true,isShowLastPageBtn:true,isShowPrePageBtn:true,isShowNextPageBtn:true,isShowTotalPage:false,isShowTotalRecords:false,isGoPage:false,hrefFormer:"",hrefLatter:"",gopageWrapId:"kkpager_gopage_wrap",gopageButtonId:"kkpager_btn_go",gopageTextboxId:"kkpager_btn_go_input",lang:{
		firstPageText:"\u9996\u9875",firstPageTipText:"\u9996\u9875",lastPageText:"\u5C3E\u9875",lastPageTipText:"\u5C3E\u9875",prePageText:"\u4E0A\u4E00\u9875",prePageTipText:"\u4E0A\u4E00\u9875",nextPageText:"\u4E0B\u4E00\u9875",nextPageTipText:"\u4E0B\u4E00\u9875",totalPageBeforeText:"\u5171",totalPageAfterText:"\u9875",totalRecordsAfterText:"\u6761\u6570\u636E",gopageBeforeText:"\u8F6C\u5230",gopageButtonOkText:"\u786E\u5B9A",gopageAfterText:"\u9875",buttonTipBeforeText:"\u7B2C",buttonTipAfterText:"\u9875"
	}
	,getLink:function(a){
		if(a==1){
	...
	,generPageHtml:function(c,l){
		...
		var j="";
		if(this.isGoPage){
			j="&nbsp;"+this.lang.gopageBeforeText+'<span id="'+this.gopageWrapId+'"><input type="button" id="'+this.gopageButtonId+'" onclick="kkpager.gopage()" value="'+this.lang.gopageButtonOkText+'" /><input type="text" id="'+this.gopageTextboxId+'" onfocus="kkpager.focus_gopage()"   onblur="kkpager.blur_gopage()" value="'+this.next+'" /></span>'+"&nbsp;&nbsp;"+this.lang.gopageAfterText
		}
		if(this.total<=8){
